...
a viable baseline so much as a cautionary one --- and §5.5 shows the
caveat cuts both ways, since on speech-dense video the same pipeline's
transcript channel doubles its visual channel.
...
(§1.2) --- the optimal strategy on the primary benchmark is the null
...
is domain-conditional by measurement, not conjecture --- on YouCook2 the
transcript channel doubles the visual channel and late fusion becomes
the best configuration. The optimal embedding strategy is therefore not
a fixed recipe but a measured, domain-adaptive choice, and this
